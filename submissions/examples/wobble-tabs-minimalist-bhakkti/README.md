# Wobble-Focus Tabs - Minimalist Tech Component

##  Overview
A pure CSS animated tabs component utilizing a smooth Wobble-Focus interaction transition, styled to complement Minimalist Tech interface aesthetics. Clean, modern, with playful wobbles.
...
submissions/examples/wobble-tabs-minimalist-bhakkti/
├── demo.html
├── style.css
└── README.md
### Credits
