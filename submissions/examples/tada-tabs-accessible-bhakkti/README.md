# Tada-Click Tabs - Accessible Web Layouts Component

##  Overview
A pure CSS animated tabs component utilizing a smooth Tada-Click interaction transition, styled to complement Accessible Web interface aesthetics. Fully WCAG compliant with high contrast, keyboard navigation, and reduced motion support.
...
| Feature | Description |
|---------|-------------|
|  **Tada-Click** | Active tab does a tada animation on click |
...
### File Structure
text
submissions/examples/tada-tabs-accessible-bhakkti/
├── demo.html
├── style.css
└── README.md
### Credits
