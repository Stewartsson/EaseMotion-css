# Wobble-Focus Tabs - Responsive Dashboard Component

##  Overview
A pure CSS animated tabs component utilizing a smooth Wobble-Focus interaction transition, styled to complement Responsive Dashboard interface aesthetics. Playful, professional, and responsive.
...
submissions/examples/wobble-tabs-dashboard-bhakkti/
├── demo.html
├── style.css
└── README.md
### Credits
