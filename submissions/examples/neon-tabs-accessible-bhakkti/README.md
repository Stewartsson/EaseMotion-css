# Neon Glow Tabs - Accessible Web Layouts Component

##  Overview
A pure CSS animated tabs component utilizing a smooth Neon Glow interaction transition, styled to complement Accessible Web interface aesthetics. Fully WCAG compliant with high contrast, keyboard navigation, and reduced motion support.
...
:root {
  ...
  --ease-tab-neon-intensity: 0.2;
  --ease-tab-neon-blur: 18px;
...
submissions/examples/neon-tabs-accessible-bhakkti/
├── demo.html
├── style.css
└── README.md
### Credits
