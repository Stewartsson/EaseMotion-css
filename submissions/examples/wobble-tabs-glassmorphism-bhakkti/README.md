# Wobble-Focus Tabs - Glassmorphism UI Component

##  Overview
A pure CSS animated tabs component utilizing a smooth Wobble-Focus interaction transition, styled to complement Glassmorphism UI interface aesthetics. Frosted glass, blur effects, and playful wobbles.
...
### File Structure
submissions/examples/wobble-tabs-glassmorphism-bhakkti/
├── demo.html
├── style.css
└── README.md
### Credits
