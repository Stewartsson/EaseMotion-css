# Wobble-Focus Tabs - Neumorphic Soft Component

##  Overview
A pure CSS animated tabs component utilizing a smooth Wobble-Focus interaction transition, styled to complement Neumorphic Soft interface aesthetics. Soft, tactile, and playful.
...
submissions/examples/wobble-tabs-neumorphic-bhakkti/
├── demo.html
├── style.css
└── README.md
### Credits
