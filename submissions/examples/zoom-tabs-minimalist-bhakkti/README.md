# Zoom-Out Tabs - Minimalist Tech Component

##  Overview
A pure CSS animated tabs component utilizing a smooth Zoom-Out interaction transition, styled to complement Minimalist Tech interface aesthetics. Clean, modern, and smooth.
...
submissions/examples/zoom-tabs-minimalist-bhakkti/
├── demo.html
├── style.css
└── README.md
### Credits
