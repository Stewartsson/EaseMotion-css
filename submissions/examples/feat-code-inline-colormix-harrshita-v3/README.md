# Code-Inline CSS `color-mix()` Dynamic Theming

## Description
This PR introduces the modern CSS `color-mix()` function to the `code-inline` component. This powerful native CSS capability eliminates the need to hard-code dozen of hex values for hover, active, light, and border color variants. 
