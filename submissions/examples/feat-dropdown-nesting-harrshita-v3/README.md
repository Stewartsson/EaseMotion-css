# Dropdown Native CSS Nesting

## Description
This PR modernizes the `dropdown` component's stylesheet by utilizing the **Native CSS Nesting** specification. This allows developers to write cleaner, more hierarchical, and highly readable CSS without relying on preprocessors like Sass, Less, or Stylus.
...
## Changes
- `style.css`: A completely refactored 80+ line stylesheet containing all component logic, states, child elements, and theme overrides inside a **single** `.ease-dropdown-nesting-harrshita` block.
