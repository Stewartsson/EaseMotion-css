# Slide-Up Modal for Accessible Web Layouts

A responsive modal component that opens with a smooth slide-up animation using only HTML and CSS. This example is lightweight, accessible, customizable, and requires no JavaScript.
...
<div id="modal" class="modal-overlay">
    <div class="modal">
        ...
        <p>
            This modal enters with a smooth slide-up animation using only
            HTML and CSS.
        </p>
