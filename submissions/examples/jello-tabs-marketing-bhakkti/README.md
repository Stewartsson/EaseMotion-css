# Jello-Hover Tabs - Marketing Landing Page Component

##  Overview
A pure CSS animated tabs component utilizing a smooth Jello-Hover interaction transition, styled to complement Marketing Landing Page interface aesthetics. Playful, engaging, and fun.
...
submissions/examples/jello-tabs-marketing-bhakkti/
├── demo.html
├── style.css
└── README.md
### Credits
