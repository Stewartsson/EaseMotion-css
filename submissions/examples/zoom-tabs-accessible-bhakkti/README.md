# Zoom-Out Tabs - Accessible Web Layouts Component

##  Overview
A pure CSS animated tabs component utilizing a smooth Zoom-Out interaction transition, styled to complement Accessible Web interface aesthetics. Fully WCAG compliant with high contrast, keyboard navigation, and reduced motion support.
...
submissions/examples/zoom-tabs-accessible-bhakkti/
├── demo.html
├── style.css
└── README.md
### Credits
