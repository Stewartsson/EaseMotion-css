# Zoom-Out Tabs - Dashboard Analytics Component

##  Overview
A pure CSS animated tabs component utilizing a smooth Zoom-Out interaction transition, styled to complement Dashboard Analytics interface aesthetics. Smooth, data-driven, and modern.
...
submissions/examples/zoom-tabs-dashboard-bhakkti/
├── demo.html
├── style.css
└── README.md
### Credits
