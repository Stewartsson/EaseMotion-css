# Jello-Hover Tabs - Neumorphic Soft Component

##  Overview
A pure CSS animated tabs component utilizing a smooth Jello-Hover interaction transition, styled to complement Neumorphic Soft interface aesthetics. Soft, tactile, and playful.
...
submissions/examples/jello-tabs-neumorphic-bhakkti/
├── demo.html
├── style.css
└── README.md
## Credits
