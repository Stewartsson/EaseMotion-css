# Elastic Bounce Tabs - Neumorphic Soft Component

## 🫧 Overview
A pure CSS animated tabs component utilizing a smooth Elastic Bounce interaction transition, styled to complement Neumorphic Soft interface aesthetics. Playful, tactile, and modern.
...
submissions/examples/elastic-bounce-tabs-neumorphic-bhakkti/
├── demo.html
├── style.css
└── README.md
 ### Credits
