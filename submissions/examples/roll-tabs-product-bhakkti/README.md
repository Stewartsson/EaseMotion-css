# Horizontal Roll Tabs - Product Catalog Component

##  Overview
A pure CSS animated tabs component utilizing a smooth Horizontal Roll interaction transition, styled to complement Product Catalog interface aesthetics. Dynamic, engaging, and e-commerce focused.
...
| Feature | Description |
|---------|-------------|
|  **Horizontal Roll** | Active tab rolls horizontally with 3D-like effect |
...
submissions/examples/roll-tabs-product-bhakkti/
├── demo.html
├── style.css
└── README.md
## Credits
