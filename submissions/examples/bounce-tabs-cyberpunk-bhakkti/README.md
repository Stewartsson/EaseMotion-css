# Elastic Bounce Tabs - Cyberpunk Neon Component

##  Overview
A pure CSS animated tabs component utilizing a smooth Elastic Bounce interaction transition, styled to complement Cyberpunk Neon interface aesthetics. Vibrant, edgy, and futuristic.
...
:root {
  ...
  --ease-tab-bounce-duration: 0.7s;
  
  /* Animation - Elastic Bounce */
  --ease-tab-duration: 0.7s;
...
### File Structure
text
submissions/examples/bounce-tabs-cyberpunk-bhakkti/
├── demo.html
├── style.css
└── README.md
### Credits
