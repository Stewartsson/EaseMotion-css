# Micro Shake Tabs - Marketing Landing Page Component

##  Overview
A pure CSS animated tabs component utilizing a smooth Micro Shake interaction transition, styled to complement Marketing Landing Page interface aesthetics. Playful, engaging, and conversion-focused.
...
submissions/examples/shake-tabs-marketing-bhakkti/
├── demo.html
├── style.css
└── README.md
### Credits
