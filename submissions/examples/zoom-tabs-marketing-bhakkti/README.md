# Zoom-Out Tabs - Marketing Landing Page Component

##  Overview
A pure CSS animated tabs component utilizing a smooth Zoom-Out interaction transition, styled to complement Marketing Landing Page interface aesthetics. Smooth, engaging, and conversion-focused.
...
submissions/examples/zoom-tabs-marketing-bhakkti/
├── demo.html
├── style.css
└── README.md
## Credits
